...
public class PaymentController {
    ...
    static {
        hashMap.put(1L, new Payment(1, "xcxcxcxcxcxcxcxcxcxcxcxcxc11111111"));
        hashMap.put(2L, new Payment(2, "xcxcxcxcggggggggg2222222222222222"));
        hashMap.put(3L, new Payment(3, "xcxcxcxccxxcxcfafdgdgdsgdsgds33333"));
    }
